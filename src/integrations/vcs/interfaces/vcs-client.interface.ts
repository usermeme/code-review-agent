import type { RepositoryIdentifier, PullRequestDetails, PrDiff, ReviewComment } from '../types/vcs.types.js';

/** 
 * Handles retrieving data from the platform. 
 */
export interface PlatformClient {
  getPullRequest(repo: RepositoryIdentifier, prNumber: number): Promise<PullRequestDetails>;
  ...
  getHistoricalDiscussions(repo: RepositoryIdentifier): AsyncIterableIterator<import('../types/vcs.types.js').HistoricalDiscussion>;
