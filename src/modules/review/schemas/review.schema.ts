...
export const findingSchema = z.object({
  ...
  startLine: z.number().int().describe('First line on the NEW side of the diff'),
  ...
  suggestion: z.string().optional().describe('Replacement code for the flagged lines, if applicable'),
});
...
export const reviewPlanSchema = z.object({
  ...
  ticketCoverage: z.string().optional().describe('Markdown section on ticket completeness'),
  findings: z.array(findingSchema),
});
