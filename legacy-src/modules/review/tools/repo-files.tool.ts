...
export async function readRepoFile(
  ...
  { path: string; totalLines: number; content: string } | { error: string }
> {
  ...
  return new FunctionTool({
    ...
    parameters: z.object({
      ...
      startLine: z
        ...
        .positive()
        .optional()
        .describe('First line to read (default 1)'),
      endLine: z
        .number()
        .int()
        .positive()
        .optional()
        .describe('Last line to read'),
    }),
    execute: ({ path, startLine, endLine }) =>
      readRepoFile(dir, { path, startLine, endLine }),
  });
}
  ...
  return new FunctionTool({
    ...
    parameters: z.object({
      ...
      glob: z
        .string()
        .optional()
        .describe("Limit to paths matching this pathspec, e.g. 'src/**/*.ts'"),
    }),
